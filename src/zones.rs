/// Source unique des zones Atlas — partagée entre l'API et l'agrégation des flux.
...
/// Retourne le nom de la zone la plus proche du point donné.
pub fn snap_nearest(lat: f64, lon: f64) -> Option<&'static str> {
    ZONES.iter()
